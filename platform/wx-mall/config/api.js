...
const API_BASE_URL = 'http://192.168.1.65:8081' + root;
module.exports = {
  ...
  PendantListByUser: API_BASE_URL + 'terminal/listByUser',  // 吊坠列表
  PendantDetail: API_BASE_URL + 'terminal/detail',  // 详情
  PendantSave: API_BASE_URL + 'terminal/save',  //保存 
  //AddressDelete: API_BASE_URL + 'address/delete',  //删除收货地址
};
