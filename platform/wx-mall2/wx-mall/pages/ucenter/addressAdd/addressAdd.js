  ...
  loadCity: function (latitude, longitude) {
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        var city_id = res.data.result.addressComponent.city;
        var province_id = res.data.result.addressComponent.province;
        var district_id = res.data.result.addressComponent.district;
...
//明天改
        district_id = district.replace("省", "");
        page.setData({ district_id: district });
